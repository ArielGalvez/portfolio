...
export function DarkModeSwitch(props: Props): React.ReactElement {
	...
	return (
		...
		>
			<div
				className={`absolute text-2xl left-1 transition-all ease-in duration-300 ${
					theme === 'light' ? 'top-1' : 'top-[-24px]'
				}`}
			>
				<svg
					stroke='currentColor'
